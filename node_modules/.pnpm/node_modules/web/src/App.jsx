...
function App() {
  ...
  const loadFromHistory = (historicalResult) => {
                ...
                <div className="space-y-3 max-h-64 overflow-y-auto">
                  {calculationHistory.map((item, index) => (
                    ...
                    >
                      ...
                      <div className={parseFloat(item.profitLoss) >= 0 ? "text-green-600 font-medium" : "text-red-600 font-medium"}>
                        {parseFloat(item.profitLoss) >= 0 ? '+' : ''}{item.profitLoss} {item.accountCurrency}
                      </div>
                    </div>
                  ))}
                </div>
